 ...
 * `AccountService`, `CategoryService`, `IncomeService`, `ExpenseService` e
 * `DebtService` já usam o backend Spring Boot via
 * `HttpAccountService`/`HttpCategoryService`/`HttpIncomeService`/
 * `HttpExpenseService`/`HttpDebtService`; os demais domínios continuam em
